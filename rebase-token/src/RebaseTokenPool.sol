...
contract RebaseTokenPool is TokenPool {
        ...
        returns (Pool.LockOrBurnOutV1 memory lockOrBurnOut)
    {
        ...
        // @note: The way that CCIP works is that you do a token approval to the pool contract
        // and then you send the tokens to CCIP; then CCIP will transfer the tokens to the pool contract
        // => we need to burn the tokens from the pool contract (address(this))
